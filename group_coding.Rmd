...
RSV = function(t,t0,params){
    with(as.list(c(t0,params)),{
        ...
        # age 60 years over
        dS60= -tau*num.s60/num *(M[6,1]*num.i06 + M[6,2]*num.i2+
                             M[6,3]*num.i20 + M[6,4]*num.i30+
                             M[6,5]*num.i40 + M[6,6]*num.i60) -
             death*num.s60 +rho*num.r60 + age40*num.s40
        dI60= tau*num.s60/num *(M[6,1]*num.i06 + M[6,2]*num.i2+
                             M[6,3]*num.i20 + M[6,4]*num.i30+
                             M[6,5]*num.i40 + M[6,6]*num.i60) -
        ...
        list(c(
            ...
            # incidence
            incidence.06=tau*num.s06/num *(M[1,1]*num.i06 + M[1,2]*num.i2+
                             M[1,3]*num.i20 + M[1,4]*num.i30+
                             M[1,5]*num.i40 + M[1,6]*num.i60),
            incidence.2=tau*num.s2/num *(M[2,1]*num.i06 + M[2,2]*num.i2+
                             M[2,3]*num.i20 + M[2,4]*num.i30+
                             M[2,5]*num.i40 + M[2,6]*num.i60),
            incidence.20=tau*num.s20/num *(M[3,1]*num.i06 + M[3,2]*num.i2+
                             M[3,3]*num.i20 + M[3,4]*num.i30+
                             M[3,5]*num.i40 + M[3,6]*num.i60),
            incidence.30=tau*num.s30/num *(M[4,1]*num.i06 + M[4,2]*num.i2+
                             M[4,3]*num.i20 + M[4,4]*num.i30+
                             M[4,5]*num.i40 + M[4,6]*num.i60),
            incidence.40=tau*num.s40/num *(M[5,1]*num.i06 + M[5,2]*num.i2+
                             M[5,3]*num.i20 + M[5,4]*num.i30+
                             M[5,5]*num.i40 + M[5,6]*num.i60),
            incidence.60=tau*num.s60/num *(M[6,1]*num.i06 + M[6,2]*num.i2+
                             M[6,3]*num.i20 + M[6,4]*num.i30+
                             M[6,5]*num.i40 + M[6,6]*num.i60)
